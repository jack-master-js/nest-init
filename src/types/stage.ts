...
export default class Stage {
    ...
    private timer_i: any = null;
    private processes: any = new Map();

    public index: number = -1;
    public duration: number = 0;
    public startTime: number = 0;

    private isBeforeAll: boolean;
    private isAfterAll: boolean;
    ...
    private _defaultDuration(stageName) {
        let duration = 0;
